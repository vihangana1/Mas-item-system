...
{{--        <span class="fs-5 fw-bold text-uppercase tracking-wider" style="letter-spacing: 1px; color: #359090;">Navigation</span>--}}
    ...
    <ul class="nav nav-pills flex-column mb-auto gap-1">
        <li class="nav-item">
            <a href="{{ route('userdashboard') }}" class="nav-link {{ request()->routeIs('userdashboard') ? 'active' : 'text-white' }}" aria-current="page">
                <i class="bi bi-house-door-fill me-2"></i>
                Home
            </a>
        </li>
        <li>
            <a href="{{ route('userDieselPage') }}" class="nav-link {{ request()->routeIs('userDieselPage') ? 'active' : 'text-white' }}">
